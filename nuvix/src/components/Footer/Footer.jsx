...
export default function Footer() {
  return (
    <footer className="bg-white p-8 lg:ml-72">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <form className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
            <input type="email" placeholder="Enter your email" className="w-full sm:flex-1 px-4 py-2 rounded-xl border border-gray-200 min-w-0" />
            <button type="submit" className="w-full sm:w-auto inline-flex items-center justify-center bg-indigo-600 text-white rounded-xl px-3 py-2 hover:bg-indigo-700">
