...
export default function Footer({ withSidebarOffset = false }) {
  const footerClassName = withSidebarOffset ? "bg-white p-8 lg:ml-72" : "w-full bg-white px-8 py-8";
      ...
      <div className="mx-auto w-full max-w-screen-2xl">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <a href="https://www.facebook.com/share/1DX2ix5KkV/" aria-label="facebook" title="Facebook" className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 text-gray-700 hover:bg-indigo-50">
              ...
              <a href="#" aria-label="instagram" title="Instagram" className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 text-gray-700 hover:bg-indigo-50">
              ...
              <a href="#" aria-label="twitter" title="Twitter" className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 text-gray-700 hover:bg-indigo-50">
              ...
              <a href="#" aria-label="youtube" title="YouTube" className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 text-gray-700 hover:bg-indigo-50">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              ...
              <li><a href="/how-is-work">How is work</a></li>
          ...
          <div>
            <h3 className="mb-4 text-sm font-semibold text-gray-800">NEWSLETTER</h3>
            <p className="mb-3 text-sm text-gray-500">Subscribe to get updates and exclusive offers.</p>
            <form className="flex flex-col gap-2 sm:flex-row sm:items-center">
              <input type="email" placeholder="Enter your email" className="min-w-0 w-full rounded-xl border border-gray-200 px-4 py-2 sm:flex-1" />
              <button type="submit" className="inline-flex w-full items-center justify-center rounded-xl bg-indigo-600 px-3 py-2 text-white hover:bg-indigo-700 sm:w-auto">
