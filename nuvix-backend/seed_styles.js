...
async function seedStyles() {
  try {
    ...
    console.log("Seeding default T-Shirt Styles...");
    for (const styleData of defaultStyles) {
      await TShirtStyle.findOneAndUpdate(
    ...
    console.log("✅ SUCCESS: Default T-Shirt Styles seeded successfully into database!");
    await mongoose.connection.close();
  } catch (error) {
    console.error("Failed to seed styles:", error);
    process.exit(1);
  }
}
